    ...
    <div className="max-w-5xl mx-auto py-10 sm:py-14 px-4 sm:px-6 lg:px-8 space-y-10">
      ...
      <div className="space-y-6 text-xs text-zinc-300 leading-relaxed">
        ...
        <section className="bg-surface-card border border-zinc-800 rounded-2xl p-6 space-y-3">
          ...
          <p>
            An official festival entry fee of <strong>$4.99 USD</strong> (approx. <strong>Rs. 1,550 LKR</strong>) is required per film submission to cover jury review honorariums, 4K DCP transcoding, and cloud distribution infrastructure. Submission fees are non-refundable once the film enters jury evaluation.
          </p>
        </section>
