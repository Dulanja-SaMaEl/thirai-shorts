      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent flex items-center justify-center">
            <div className="w-12 h-12 rounded-full bg-gold-gradient p-0.5 shadow-gold-glow group-hover:scale-110 transition-transform opacity-90 group-hover:opacity-100">
              <div className="w-full h-full bg-black rounded-full flex items-center justify-center">
                <ExternalLink className="w-5 h-5 text-gold-400 fill-gold-400 ml-0.5" />
              </div>
            </div>
          </div>
